...
namespace Utils.Reflection.Extensions
{
    /// <summary>
    ...
    {
        public static List<Type> GetGenericProperties(this Type type)
        {
            return type
                .GetProperties()
        ...
        /// <returns></returns>
        public static IEnumerable<Type> GetDerivedTypes(this Type type, Assembly entryAssembly = null)
        {
